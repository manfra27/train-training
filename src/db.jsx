        ...
        subcategories: [
            {
                ...
                entries: [
                    ...
                    { "term": "Micro Integrator message transformation", "explanation": "1 adding/removing content from messages,\n 2 converting a message to a completely different message format,\n validating messages based on the available validation mechanisms of the message format. ", "question": "" },
